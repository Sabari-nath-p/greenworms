      ...
      child: Text(
        ...
        Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: Color.fromRGBO(0, 124, 88, 0.2), width: 1),
              ),
            ),
          ),
           Positioned(
        ...
        Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: Color.fromRGBO(3, 97, 99, 1), width: 1),
              ),
       ...
       Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(5),
                border: Border.all(color: Color.fromRGBO(244, 103, 103, 1), width: 1),
              ),
              child: ElevatedButton(
                onPressed: () {},
                style: ElevatedButton.styleFrom(
