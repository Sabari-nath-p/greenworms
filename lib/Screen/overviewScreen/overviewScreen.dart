    ...
    return SafeArea(
      child: Scaffold(
        body: GetBuilder<overviewController>(
          builder: (_) {
            return (mctrl.data == null) ? Center(child: LoadingAnimationWidget.staggeredDotsWave(color: Colors.orange, size: 40),):Column(
              ...
              children: [
                ...
                Expanded(
                 ...
                 if (mctrl.data[2]["images"].isNotEmpty)   
                 SizedBox(height:1.5.h),
                    Container(
                          width: 89.47.w,
                          height: 18.9.h,
                          ...
                          child: Image.network(mctrl.data[2]["images"][0]["imgUrl"]),
                        ),
                        SizedBox(height:1.5.h),
                        Container(
                          width: 100.w,
                       ...
                       Container(
                          ...
                          child: Image.network(mctrl.data[3]["images"][0]["imgUrl"]),
                        ),
                      ...
                      mctrl.data[4]["weight"].toString(),
                       ...
                       Container(
                          ...
                          child: Image.network(mctrl.data[4]["images"][0]["imgUrl"]),
                        ),
                        ...
                        SizedBox(height:1.8.h),
                         Container(
                          ...
                          child: Image.network(mctrl.data[5]["images"][0]["imgUrl"]),
                        ),
